...
- **Quick Collision** - Quickly create export-ready collisions for props
- **YMAP Editing** - Import, edit and create GTA V maps with real prop placement
- **MLO Support** - Import and edit interiors or place custom MLOs into the world
- **YCD Animations** - Import and export animations with UV animation support and live viewport playback
- **YTD Textures** - Load and manage GTA V textures directly from your game installation
...
3. Open **3ds Max**.
4. Drag `INSTALL - Drag into 3ds Max.ms` into the viewport.
...
If you find a bug, have a suggestion or need help using RAGE Evo, please open an issue or join the Discord.
